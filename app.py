...
# =========================
# ROTA DE ADMIN — INSERIR JOGOS ELIMINATÓRIOS
# Corre UMA VEZ para inserir os jogos das fases eliminatórias na DB
# Aceder em: /admin/insert-knockout-games (só admin)
# APAGAR depois de correr
# =========================
@app.route("/admin/insert-knockout-games")
def insert_knockout_games():
    ...
    # Verificar se já existem jogos eliminatórios
    existing = conn.execute("SELECT COUNT(*) FROM games WHERE stage_id > 1").fetchone()[0]
    if existing > 0:
        conn.close()
        return jsonify({"status": "error", "message": f"Já existem {existing} jogos eliminatórios na DB — não inserido"}), 400

    knockout_games = [
        # Segundas de Final
        (None,None,2,'2026-06-28','23:00','2026-06-28 23:00:00'),
        (None,None,2,'2026-06-29','02:00','2026-06-29 02:00:00'),
        (None,None,2,'2026-06-29','20:00','2026-06-29 20:00:00'),
        (None,None,2,'2026-06-29','23:00','2026-06-29 23:00:00'),
        (None,None,2,'2026-06-30','02:00','2026-06-30 02:00:00'),
        (None,None,2,'2026-06-30','20:00','2026-06-30 20:00:00'),
        (None,None,2,'2026-06-30','23:00','2026-06-30 23:00:00'),
        (None,None,2,'2026-07-01','02:00','2026-07-01 02:00:00'),
        (None,None,2,'2026-07-01','20:00','2026-07-01 20:00:00'),
        (None,None,2,'2026-07-01','23:00','2026-07-01 23:00:00'),
        (None,None,2,'2026-07-02','02:00','2026-07-02 02:00:00'),
        (None,None,2,'2026-07-02','20:00','2026-07-02 20:00:00'),
        (None,None,2,'2026-07-02','23:00','2026-07-02 23:00:00'),
        (None,None,2,'2026-07-03','02:00','2026-07-03 02:00:00'),
        (None,None,2,'2026-07-03','20:00','2026-07-03 20:00:00'),
        (None,None,2,'2026-07-03','23:00','2026-07-03 23:00:00'),
        # Oitavas de Final
        (None,None,3,'2026-07-05','20:00','2026-07-05 20:00:00'),
        (None,None,3,'2026-07-05','23:00','2026-07-05 23:00:00'),
        (None,None,3,'2026-07-06','20:00','2026-07-06 20:00:00'),
        (None,None,3,'2026-07-06','23:00','2026-07-06 23:00:00'),
        (None,None,3,'2026-07-07','20:00','2026-07-07 20:00:00'),
        (None,None,3,'2026-07-07','23:00','2026-07-07 23:00:00'),
        (None,None,3,'2026-07-08','20:00','2026-07-08 20:00:00'),
        (None,None,3,'2026-07-08','23:00','2026-07-08 23:00:00'),
        # Quartas de Final
        (None,None,4,'2026-07-10','23:00','2026-07-10 23:00:00'),
        (None,None,4,'2026-07-11','02:00','2026-07-11 02:00:00'),
        (None,None,4,'2026-07-11','23:00','2026-07-11 23:00:00'),
        (None,None,4,'2026-07-12','02:00','2026-07-12 02:00:00'),
        # Semifinal
        (None,None,5,'2026-07-14','23:00','2026-07-14 23:00:00'),
        (None,None,5,'2026-07-15','23:00','2026-07-15 23:00:00'),
        # Terceiro Lugar
        (None,None,6,'2026-07-18','20:00','2026-07-18 20:00:00'),
        # Final
        (None,None,7,'2026-07-19','20:00','2026-07-19 20:00:00'),
    ]

    for game in knockout_games:
        conn.execute("""
            INSERT INTO games (team_home_id, team_away_id, stage_id, game_date, game_time, game_datetime)
            VALUES (?, ?, ?, ?, ?, ?)
        """, game)

    conn.commit()
    total = conn.execute("SELECT COUNT(*) FROM games WHERE stage_id > 1").fetchone()[0]
    conn.close()

    return jsonify({
        "status": "ok",
        "message": "Jogos eliminatórios inseridos com sucesso",
        "total_inserido": len(knockout_games),
        "total_na_db": total
    })
