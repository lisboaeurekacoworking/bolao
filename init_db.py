...
def init_db():
    ...
    if existing_games == 0:
        conn.executescript("""
            ...
            -- Segundas de Final (sem equipas definidas ainda)
            (NULL,NULL,2,'2026-06-28','23:00','2026-06-28 23:00:00'),
            (NULL,NULL,2,'2026-06-29','02:00','2026-06-29 02:00:00'),
            (NULL,NULL,2,'2026-06-29','20:00','2026-06-29 20:00:00'),
            (NULL,NULL,2,'2026-06-29','23:00','2026-06-29 23:00:00'),
            (NULL,NULL,2,'2026-06-30','02:00','2026-06-30 02:00:00'),
            (NULL,NULL,2,'2026-06-30','20:00','2026-06-30 20:00:00'),
            (NULL,NULL,2,'2026-06-30','23:00','2026-06-30 23:00:00'),
            (NULL,NULL,2,'2026-07-01','02:00','2026-07-01 02:00:00'),
            (NULL,NULL,2,'2026-07-01','20:00','2026-07-01 20:00:00'),
            (NULL,NULL,2,'2026-07-01','23:00','2026-07-01 23:00:00'),
            (NULL,NULL,2,'2026-07-02','02:00','2026-07-02 02:00:00'),
            (NULL,NULL,2,'2026-07-02','20:00','2026-07-02 20:00:00'),
            (NULL,NULL,2,'2026-07-02','23:00','2026-07-02 23:00:00'),
            (NULL,NULL,2,'2026-07-03','02:00','2026-07-03 02:00:00'),
            (NULL,NULL,2,'2026-07-03','20:00','2026-07-03 20:00:00'),
            (NULL,NULL,2,'2026-07-03','23:00','2026-07-03 23:00:00'),
            -- Oitavas de Final
            (NULL,NULL,3,'2026-07-05','20:00','2026-07-05 20:00:00'),
            (NULL,NULL,3,'2026-07-05','23:00','2026-07-05 23:00:00'),
            (NULL,NULL,3,'2026-07-06','20:00','2026-07-06 20:00:00'),
            (NULL,NULL,3,'2026-07-06','23:00','2026-07-06 23:00:00'),
            (NULL,NULL,3,'2026-07-07','20:00','2026-07-07 20:00:00'),
            (NULL,NULL,3,'2026-07-07','23:00','2026-07-07 23:00:00'),
            (NULL,NULL,3,'2026-07-08','20:00','2026-07-08 20:00:00'),
            (NULL,NULL,3,'2026-07-08','23:00','2026-07-08 23:00:00'),
            -- Quartas de Final
            (NULL,NULL,4,'2026-07-10','23:00','2026-07-10 23:00:00'),
            (NULL,NULL,4,'2026-07-11','02:00','2026-07-11 02:00:00'),
            (NULL,NULL,4,'2026-07-11','23:00','2026-07-11 23:00:00'),
            (NULL,NULL,4,'2026-07-12','02:00','2026-07-12 02:00:00'),
            -- Semifinal
            (NULL,NULL,5,'2026-07-14','23:00','2026-07-14 23:00:00'),
            (NULL,NULL,5,'2026-07-15','23:00','2026-07-15 23:00:00'),
            -- Terceiro Lugar
            (NULL,NULL,6,'2026-07-18','20:00','2026-07-18 20:00:00'),
            -- Final
            (NULL,NULL,7,'2026-07-19','20:00','2026-07-19 20:00:00');
                    """)
